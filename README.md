...
This test suite has been created to make the generation of the HTTP requests easier, which will be the entry point of the whole process.
...
The component executes the search by a utility class [YahooSearchUtil.java](https://github.com/dmunozr/docker-camel-activemq/blob/master/final-consumer/src/main/java/com/demo/util/YahooSearchUtil.java). 
